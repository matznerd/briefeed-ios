...
enum AccessibilityID {
    ...
    enum Radio {
        ...
        static func sourceFailure(_ feedID: String) -> String {
            "radio.sourceFailure.\(feedID)"
        }
        ...
        static func archiveOptions(_ key: RadioEpisodeKey) -> String {
            "radio.archiveOptions.\(key.feedID).\(key.episodeID)"
        }
