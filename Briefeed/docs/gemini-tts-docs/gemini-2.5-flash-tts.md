# Gemini 2.5 Flash TTS (model: `gemini-2.5-flash-preview-tts`)

> **Note:** As of now, the Gemini API model id for Flash TTS is still the preview name: `gemini-2.5-flash-preview-tts`.
