...
> **Live Radio MVP focus (updated July 20, 2026):** The independently shippable Live Radio experience specified in [`docs/superpowers/specs/2026-07-19-live-radio-mvp-design.md`](superpowers/specs/2026-07-19-live-radio-mvp-design.md) and sequenced in [`docs/superpowers/plans/2026-07-19-live-radio-mvp.md`](superpowers/plans/2026-07-19-live-radio-mvp.md) is implemented. It supersedes this PRD's temporary, non-persisted Live News behavior and broader phase ordering for the Radio slice. Deterministic Radio units, focused Brief regressions, and the complete 15-test Radio UI suite pass on the owned iPhone 15 Pro / iOS 18.6 simulator; Analyze, signed archive, and App Store export also pass. The build is ready for an explicitly approved physical-device test, but audible playback, Lock Screen/Control Center, routes, interruptions, and sleep-under-lock remain `NOT RUN`, so it is not yet a distribution candidate. See [`docs/release/LIVE-RADIO-DISTRIBUTION-RECEIPT.md`](release/LIVE-RADIO-DISTRIBUTION-RECEIPT.md).

**Date:** December 17, 2025
**Version:** 2.1 - All Requirements Finalized
**Status:** Phase 1 implemented (pending validation)
